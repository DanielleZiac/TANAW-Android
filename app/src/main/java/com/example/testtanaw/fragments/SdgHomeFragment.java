...
public class SdgHomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        List<SDGItem> sdgList = Arrays.asList(
                new SDGItem("No Poverty", R.drawable.sdg_1),
                new SDGItem("Goal 2", R.drawable.sdg_2),
                new SDGItem("Goal 3", R.drawable.sdg_3),
                new SDGItem("Goal 4", R.drawable.sdg_4),
                new SDGItem("Goal 5", R.drawable.sdg_5),
                new SDGItem("Goal 6", R.drawable.sdg_6),
                new SDGItem("Goal 7", R.drawable.sdg_7),
                new SDGItem("Goal 8", R.drawable.sdg_8),
                new SDGItem("Goal 9", R.drawable.sdg_9),
                new SDGItem("Goal 10", R.drawable.sdg_10),
                new SDGItem("Goal 11", R.drawable.sdg_11),
                new SDGItem("Goal 12", R.drawable.sdg_12),
                new SDGItem("Goal 13", R.drawable.sdg_13),
                new SDGItem("Goal 14", R.drawable.sdg_14),
                new SDGItem("Goal 15", R.drawable.sdg_15),
                new SDGItem("Goal 16", R.drawable.sdg_16),
                new SDGItem("Goal 17", R.drawable.sdg_17)
        );
